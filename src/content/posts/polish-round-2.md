---
title: "카테고리 메뉴 추가하기"
description: "헤더의 카테고리·햄버거 메뉴 등을 추가한 과정"
pubDate: 2026-06-20
category: "블로그"
...
이번에도 새 기능을 크게 더하진 않았다. [[polish-round]]에서 한 차례 깎아낸 뒤로도, 쓰고 읽는 화면엔 손볼 곳이 남아 있었다. 다만 이번엔 길이 하나 신설되었다. 카테고리별로 글을 모아 볼 수 있게 된 것이다.
