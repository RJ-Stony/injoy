---
title: "카테고리라는 새 길, 그리고 또 한 겹의 잔손질"
description: "헤더 카테고리·모바일 햄버거·조회수 자리잡기·그래프 태그선을 깎아낸 회차"
pubDate: 2026-06-20
category: "블로그"
...
글이 늘면서 블로그·글쓰기·회고 같은 갈래가 생겼다. 그런데 갈래별로 모아 보는 길이 없었다. 헤더에 카테고리 메뉴를 더했다. 누르면 갈래가 펼쳐지고, 고르면 그 갈래의 글만 모인 페이지로 간다. 카드의 카테고리 뱃지를 눌러도 같은 곳으로 간다.
